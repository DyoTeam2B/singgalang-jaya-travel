...
| Perbaikan bug okupansi trip, penumpang driver, validasi armada, & validasi transfer | NYS/KVN | Pembatasan kapasitas, sum penumpang, cek ganda armada, & validasi transfer client-side | ✅ Selesai |
...
## Perbaikan Tasks (dari perbaikan.md)

### Rayfo — Area: Landing Page & General

| No | No. Ref | Tugas | Status |
|----|---------|-------|--------|
| 1 | #2 | Ubah susunan kalimat perjalanan "Padang Panjang ke Pekanbaru" → "Pekanbaru ↔ Padang Panjang" | ✅ Selesai |
| 2 | #3 | Jumlah penumpang diambil dari database | ✅ Selesai |
| 3 | #4 | Rating diambil dari database (rumus: Total Bintang ÷ Jumlah Ulasan) | ✅ Selesai |
| 4 | #5 | Ubah text "2 Jam" jadi "± 2 Jam" | ✅ Selesai |
| 5 | #6 | Ubah logo di bagian "Kenapa Memilih Singgalang Jaya Travel" (menggunakan rute.png) | ✅ Selesai |
| 6 | #7 | Sesuaikan jumlah penumpang (statistik) | 🔲 |
| 7 | #8 | Sesuaikan jumlah rating (statistik) | 🔲 |
| 8 | #9 | Sesuaikan jumlah rute (statistik) | 🔲 |
| 9 | #10 | Sesuaikan "Tepat Waktu" (statistik) | 🔲 |
| 10 | #28 | Perbaiki format notifikasi WhatsApp | 🔲 |
