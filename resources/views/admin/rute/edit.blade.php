...
@section('content')
    <div class="max-w-2xl mx-auto space-y-8 font-poppins">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-[10px] font-bold text-blue-600 uppercase tracking-[0.3em] mb-1">Ubah Rute</p>
                <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Edit Rute</h1>
            </div>
        </div>
