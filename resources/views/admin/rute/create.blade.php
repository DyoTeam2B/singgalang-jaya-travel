...
@section('content')
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em] mb-1">Tambah Rute</p>
                <h1 class="text-3xl font-black text-slate-900 tracking-tight">Rute Baru</h1>
            </div>
        </div>
