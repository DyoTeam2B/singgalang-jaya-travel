...
@section('content')
    <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em] mb-1">Ubah Jadwal</p>
        ...
        <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-900/5 overflow-hidden">
            <form method="POST" action="{{ route('admin.jadwal.update', $jadwal->id) }}" class="p-8 sm:p-10 space-y-6">
                ...
                <!-- Status Jadwal -->
                <div class="space-y-2">
                    <label for="status_jadwal" class="text-[10px] font-black text-slate-500 uppercase tracking-widest block">Status Jadwal</label>
