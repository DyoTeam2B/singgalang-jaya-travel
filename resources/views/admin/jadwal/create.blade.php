...
@section('content')
    <div class="max-w-2xl mx-auto space-y-8 font-poppins">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-[10px] font-bold text-blue-600 uppercase tracking-[0.3em] mb-1">Tambah Jadwal</p>
                <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Jadwal Baru</h1>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2rem] border border-slate-200/80 shadow-sm overflow-hidden">
            <form method="POST" action="{{ route('admin.jadwal.store') }}" class="p-8 sm:p-10 space-y-6">
                ...
                <!-- Status Jadwal -->
                <div class="space-y-2">
                    <label for="status_jadwal" class="text-[10px] font-black text-slate-400 uppercase tracking-widest block px-1">Status Awal</label>
